...
struct rtl8xxxu_reg8val rtl8xxxu_gen1_mac_init_table[] = {
	...
	{0x709, 0x43}, {0x70a, 0x65}, {0x70b, 0x87}, {0xffff, 0xff},
};
...
{
	rtl8xxxu_write8(priv, REG_AMPDU_MIN_SPACE, 0x07);
}
			       ...
			       u32 ramask, u8 rateid, int sgi)
{
	...
	dev_dbg(&priv->udev->dev,
		"%s: rate mask %08x, arg %02x, size %zi, sgi %d\n", __func__,
		ramask, h2c.ramask.arg, sizeof(h2c.ramask),sgi);
...
void rtl8xxxu_debugfs_init(struct rtl8xxxu_priv *priv)
{
	...
	debugfs_create_file("mac_reg_dump", S_IFREG | 0444, priv->debugfs_dir,
			    &rtl8xxxu_debug_priv_macregs, &file_ops_common);
	rtl8xxxu_debug_priv_bbregs.priv = priv;
	debugfs_create_file("bb_reg_dump", S_IFREG | 0444, priv->debugfs_dir,
			    &rtl8xxxu_debug_priv_bbregs, &file_ops_common);
	rtl8xxxu_debug_priv_rfregs.priv = priv;
	debugfs_create_file("rf_reg_dump", S_IFREG | 0444, priv->debugfs_dir,
