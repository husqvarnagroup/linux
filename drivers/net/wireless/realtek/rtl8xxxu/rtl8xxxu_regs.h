...
#define  SYS_ISO_CTRL_MD2PP		BIT(0)
#define  SYS_ISO_CTRL_ANALOG_IPS	BIT(5)
#define  SYS_ISO_CTRL_BIT_7		BIT(7)
#define  SYS_ISO_CTRL_DIOR		BIT(9)
#define  SYS_ISO_CTRL_PWC_EV25V		BIT(14)
#define  SYS_ISO_CTRL_PWC_EV12V		BIT(15)
...
#define  APS_FSMCO_PFM_LDKP		BIT(2)
#define  APS_FSMCO_PFM_WOWL		BIT(3)
#define  APS_FSMCO_ENABLE_POWERDOWN	BIT(4)
#define  APS_FSMCO_PDN_PL		BIT(5)
#define  APS_FSMCO_MAC_ENABLE		BIT(8)
#define  APS_FSMCO_MAC_OFF		BIT(9)
#define  APS_FSMCO_SW_LPS		BIT(10)
#define  APS_FSMCO_HW_SUSPEND		BIT(11)
#define  APS_FSMCO_PCIE			BIT(12)
#define  APS_FSMCO_APDM_MAC		BIT(13)
#define  APS_FSMCO_APDM_HOST		BIT(14)
#define  APS_FSMCO_HW_POWERDOWN		BIT(15)
#define  APS_FSMCO_WLON_RESET		BIT(16)
#define  APS_FSMCO_SUS_HOST		BIT(17)
#define  APS_FSMCO_ROP_ALD		BIT(20)
#define  APS_FSMCO_ROP_PWR		BIT(21)
#define  APS_FSMCO_ROP_SPS		BIT(22)
#define  APS_FSMCO_SOP_MRST		BIT(25)
#define  APS_FSMCO_SOP_FUSE		BIT(26)
#define  APS_FSMCO_SOP_ABG		BIT(27)
#define  APS_FSMCO_SOP_AMB		BIT(28)
#define  APS_FSMCO_SOP_RCK		BIT(29)
#define  APS_FSMCO_SOP_A8M		BIT(30)
#define  APS_FSMCO_XOP_BTCK		BIT(31)
...
#define  RSV_CTRL_UNLOCK_MASK		0x007F

#define REG_RF_CTRL			0x001f
#define  RF_CTRL_ENABLE			BIT(0)
#define  RF_CTRL_RSTB			BIT(1)
#define  RF_CTRL_SDMRSTB		BIT(2)

#define REG_LDOA15_CTRL			0x0020
#define  LDOA15_CTRL_ENABLE		BIT(0)
#define  LDOA15_CTRL_STANDBY		BIT(1)
#define  LDOA15_CTRL_OBUF		BIT(2)
#define  LDOA15_CTRL_REG_VOS		BIT(3)
#define  LDOA15_CTRL_VOADJ_SHIFT	4

#define REG_LDOV12D_CTRL		0x0021
#define  LDOV12D_CTRL_ENABLE		BIT(0)
#define  LDOV12D_CTRL_STANDBY		BIT(1)
#define  LDOV12D_CTRL_VADJ_SHIFT	4

#define REG_LDOHCI12_CTRL		0x0022

#define REG_LPLDO_CTRL			0x0023
#define  LPLDO_CTRL_HSM			BIT(2)
#define  LPLDO_CTRL_LSM_DIS		BIT(3)

#define REG_AFE_XTAL_CTRL		0x0024
#define  AFE_XTAL_CTRL_ENABLE		BIT(0)
#define  AFE_XTAL_CTRL_B_SELECT		BIT(1)
#define  AFE_XTAL_CTRL_GATE_USB		BIT(8)
#define  AFE_XTAL_CTRL_GATE_AFE		BIT(11)
#define  AFE_XTAL_CTRL_RF_GATE		BIT(14)
#define  AFE_XTAL_CTRL_GATE_DIG		BIT(17)
#define  AFE_XTAL_CTRL_BT_GATE		BIT(20)

/*
 * 0x0028 is also known as REG_AFE_CTRL2 on 8723bu/8192eu
 */
#define REG_AFE_PLL_CTRL		0x0028
#define  AFE_PLL_CTRL_ENABLE		BIT(0)
#define  AFE_PLL_CTRL_320_ENABLE	BIT(1)
#define  APE_PLL_CTRL_FREF_SELECT	BIT(2)
#define  AFE_PLL_CTRL_EDGE_SELECT	BIT(3)
#define  AFE_PLL_CTRL_WDOGB		BIT(4)
#define  AFE_PLL_CTRL_LPF_ENABLE	BIT(5)
...
#define  TRXDMA_CTRL_QUEUE_LOW		1
#define  TRXDMA_CTRL_QUEUE_NORMAL	2
#define  TRXDMA_CTRL_QUEUE_HIGH		3
